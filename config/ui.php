...
return [
    'columns' => [
        ...
        'ten_dot' => 'Tên đợt',
        'dot_danh_gia_id' => 'Đợt đánh giá',
        'ngay_bat_dau_sinh_vien' => 'Sinh viên bắt đầu',
        'ngay_ket_thuc_sinh_vien' => 'Sinh viên kết thúc',
        'ngay_bat_dau_gvcn' => 'GVCN bắt đầu',
        'ngay_ket_thuc_gvcn' => 'GVCN kết thúc',
    ...
    'permissions' => [
        ...
        'manage all activities' => 'Quản lý mọi hoạt động',
        'manage users' => 'Quản lý người dùng',
        'manage roles' => 'Quản lý vai trò và quyền',
        'manage master data' => 'Quản lý dữ liệu nền',
        'view audit logs' => 'Xem nhật ký kiểm toán',
        'manage backups' => 'Quản lý sao lưu',
        'approve final scores' => 'Xác nhận điểm cuối cùng',
        'export reports' => 'Xuất báo cáo',
        'manage_dot_danh_gia' => 'Quản lý đợt đánh giá',
