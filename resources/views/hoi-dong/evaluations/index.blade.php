...
<div class="table-card">
    <div class="table-responsive">
        <table class="table table-hover align-middle mb-0">
            <thead class="table-light"><tr><th>Sinh viên</th><th>Lớp</th><th>Khoa</th><th>GVCN</th><th>Cuối cùng</th><th>Trạng thái</th><th class="text-end">Thao tác</th></tr></thead>
            <tbody>
                ...
                @empty
                    <tr><td colspan="7" class="text-center text-secondary py-4">Chưa có phiếu chờ xác nhận.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
